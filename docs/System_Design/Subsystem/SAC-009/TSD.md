...
| Odoo / other peer edges | external | - | Via connector env URLs | not in Compose |
...
- `orchestrator` → `postgres` and **external connector URLs** (ERP and other edges are **not** in Compose)
...
## Release / lifecycle (E-04…E-06)

| Scenario | Design touch |
|----------|----------------|
| E-04 deploy/rollback | Same Compose file; edges stay external URLs; record health smoke |
| E-05 release | Attach lint + smoke logs; do **not** close OPS/E without TR |
| E-06 blocked release | Failed required verification blocks tag/publish |

## Related

- [Guides/Compose_and_Runbook.md](./Guides/Compose_and_Runbook.md) · [Monorepo_Layout](../../TSD/Monorepo_Layout.md) · [OPS-007](./Scenarios/OPS-007.md) · [E-04](./Scenarios/E-04.md)
