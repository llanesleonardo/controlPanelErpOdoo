...
**Read this file first** when choosing how to structure ControlPanelERP code. Do **not** dump the whole synced library into context.

Primary diagram: [Epic-06 system-design](../_legacy/Epic-06/system-design.md) · Ontology UI: [SAC-006](../Subsystem/SAC-006/README.md) · ConOps: [ControlPanelERP_ConOps](../ConOps/ControlPanelERP_ConOps.md)
...
| Database per Service | D1 | Control-plane Postgres ≠ ERP DB | [32-database-per-service](../../Software%20Patterns%20Docs/Distributed_system_patterns/32-database-per-service.md) |
...
| Bounded Context | D2 | Control plane vs each SoR | [02-bounded-context](../../Software%20Patterns%20Docs/Org_System_Engineering_patterns/02-bounded-context.md) |
...
| Event Sourcing / full CQRS / Saga | D3 | Overkill until multi-SoR commits |
...
|------------------------|------------|------|-----|-------------------|
| UI talks to Odoo directly | Client-Server + BFF + API Gateway | D1 | SAC-001 / SAC-002 | — |
| Control-plane shares ERP DB | Database per Service | D1 | SAC-009 | — |
| Secrets in git / images | Secrets Vault (env → vault) | D1 | SAC-009 | — |
| Free-form NL invents ERP writes | Allowlist + Semantic Routing + PEP | D2 | SAC-001 / SAC-004 | composition: HITL / tool-calling |
| Vendor models leak into UI | ACL + Adapter + Bounded Context | D2 | SAC-005 | — |
| Risky write with no preview | Dry-run + Approval (Facade skill path) | D2 | SAC-007 | composition: Human-in-the-Loop |
| Ontology browser invents types | Product-owned Domain Model YAML | D2 | SAC-006 | — |
| Connector outage takes down panel | Circuit Breaker + Timeout + Fallback | D3 | SAC-004 / SAC-005 | recognition: Resilience examples |
| Tenant data bleed (later) | Multi-Tenant Partitioning + RBAC | D3 | SAC-001 | composition: multi-tenant billing problem |

Library risk-first philosophy (examples are **another product**): [risk-driven-patterns.md](../../Software%20Patterns%20Docs/risk-driven-patterns.md) — use for method, not as ControlPanelERP requirements.
...
See [SAC-006](../Subsystem/SAC-006/README.md), [Epic-07](../_legacy/Epic-07/README.md), [Gaps 04–06](../Subsystem/Risks.md).
...
**Policy:** see [ConOps NL/skills](../ConOps/ControlPanelERP_ConOps.md) — LLM proposes/routes; certified skills execute.
...
- [SAC-005 Odoo](../Subsystem/SAC-005/README.md)
- [SAC-009 Compose](../Subsystem/SAC-009/README.md)
- [Epic-06 system-design](../_legacy/Epic-06/system-design.md)
