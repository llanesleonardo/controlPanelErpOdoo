...
**Edge:** NestJS `apps/gateway` **is** the API Gateway — auth, tenancy, rate limits, contract validation. Do not add a second application gateway in front; optional TLS/WAF only. See [platform-concerns.md](../../TSD/ControlPanelERP_TSD.md).

**Patterns:** curated map in [pattern-map.md](../../TSD/Pattern_Selection.md). **NL vs skills:** [governed-execution.md](../../ConOps/ControlPanelERP_ConOps.md). **Ontology Language:** [ontology.md](../../Subsystem/SAC-006/README.md) / [Epic-07](../Epic-07/README.md).
...
| Agents | [Tool Calling](../../../Software%20Patterns%20Docs/AI_Agentic_patterns/03-tool-calling.md) — same gateway as Next.js; NL classifies only ([governed-execution](../../ConOps/ControlPanelERP_ConOps.md)) |
...
Customers do not implement adapters. See [connectors.md](../../Subsystem/SAC-005/README.md).

## NL / OpenClaw vs free-form execution

LLM may **route**; certified skills **execute**. Full rationale: [governed-execution.md](../../ConOps/ControlPanelERP_ConOps.md).
