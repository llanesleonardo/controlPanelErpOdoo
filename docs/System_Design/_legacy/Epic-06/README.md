...
- **Auth:** keep **dev-actor** (`X-Actor-Id`) for Epic-06 implementation; full auth/RBAC + multi-tenant are specified in [platform-concerns.md](../../TSD/ControlPanelERP_TSD.md) and must land before multi-customer prod
...
See also [connectors.md](../../Subsystem/SAC-005/README.md), [system-design.md](./system-design.md), and [pattern-map.md](../../TSD/Pattern_Selection.md).
