...
**Upstream:** [Epic-01 Docker](../../../Epic-01/phase-01/task-04-docker-compose-strategy/SRD.md) · [Deployment/Docker](../../../../Deployment/Docker/README.md)  
...
- Document commands in Deployment/Docker + docker/README
...
**Docs** — Deployment/Docker and docker/README shall document the exact up/down commands.
